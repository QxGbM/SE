			...
			if (s[0].equals("damage")) {
				if (s[1].equals("self")) {
					...
					if (!Coop.minions[0].isEmpty()) {
						Coop.minions[0].mpDeduct(Integer.valueOf(s[2]));
						Coop.minions[0].hpDeduct(Integer.valueOf(s[3]));
					}
					if (!Coop.minions[1].isEmpty()) {
						Coop.minions[1].mpDeduct(Integer.valueOf(s[2]));
