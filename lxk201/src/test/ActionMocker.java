	...
	public static void main(String[] args) {
		...
		combobox.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				if(combobox.getSelectedItem().equals("quickmatch enter"))
					textarea.setText("");
				if(combobox.getSelectedItem().equals("quickmatch accept"))
					textarea.setText("");
		...
		send.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				String s;
				if (combobox.getSelectedItem().equals("quickmatch enter"))
					s = "Quickmatch " + playerID + " enter";
				else if (combobox.getSelectedItem().equals("quickmatch accept"))
					s = "Message 101 0 BattleRequest Accept " + MatchNum;
				else if (combobox.getSelectedItem().equals("custom"))
					s = textarea.getText();
				else
