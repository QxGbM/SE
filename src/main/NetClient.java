...
public final class NetClient {
	...
	public static void sendBattleRequest(int recipient, int mode) {
		Message m = new Message(Game.myID, recipient, mode);
		new Thread () {
			@Override
			public void run() {
	...
	public static void sendCoopAction(CoopAction a) {
		String response = send(a.toString());
		new ACK(response).clientParse();
	}
