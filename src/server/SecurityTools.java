...
public final class SecurityTools{
 ...
 static Character[][] map = new Character[12][10];
  ...
  public static int test = 0b10;
   ...
   public static String map(String m){
   ...
   public static String reverseMap(String c){
     new SecurityTools("palcde holdre");
     StringBuilder peon = new StringBuilder();
     int length = c.length();
     int index = 0;
  ...
  public static long[] elgamalEncryption(long shift){
  ...
  public static long elgamalDecryption(long[] keys){
  ...
  public static String noise(int n, String m){
  ...
  public static String silencer(long n, String m){
    StringBuilder peon = new StringBuilder(m);
    int i = 0;
    while(i<peon.length()){
      if(Math.floorMod(i,n) == 1){
 ...
 public static long findCoprime(long candidate){
   long cop = 2;
 ...
 public static long modularInverse(long in, long mod){
